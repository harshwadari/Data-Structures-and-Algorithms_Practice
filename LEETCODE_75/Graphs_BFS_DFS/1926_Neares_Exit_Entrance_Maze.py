...
walls (represented as '+'). You are also given the entrance of the maze, where entrance = [entrancerow, entrancecol] denotes the row and column of the cell you are initially standing at.
    ...
    def nearestExit(self, maze, entrance):
        ...
        while len(queue) != 0:
            ...
            for i,j in directions:
                ni = i + r
                nj = j + c
                if ni >= 0 and ni < rows and nj >= 0 and  nj < cols and maze[ni][nj] ==  ".":
                    if ni == 0 or nj == 0 or ni == rows - 1 or nj == cols - 1:
                        return steps + 1
